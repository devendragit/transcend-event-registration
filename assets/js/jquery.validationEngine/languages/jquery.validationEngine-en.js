        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "date_format": {                    
                    //  Check if date is valid by leap year
                   "func": function (field) {
                        var pattern = new RegExp(/^(0[1-9]|1[012])[\/|-](0[1-9]|[12][0-9]|3[01])[\/|-](19\d\d|2\d\d\d)$/);
                        ...
                        //alert((date.getFullYear() == year && date.getMonth() == (month - 1) && date.getDate() == day));
        
                        return (date.getFullYear() == year && date.getMonth() == (month - 1) && date.getDate() == day);
                    },                      
                    "alertText": "* Invalid date or format, must be in MM/DD/YYYY format"
                },
                /*"date_format": {
                    //MM/DD/YYYY
