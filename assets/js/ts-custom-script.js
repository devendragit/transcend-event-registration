...
var updateRoutineTimes = function() {
	...
	var start_date = jQuery('#acf-field_59d2674b099e9-0-field_59d2674f77b98').val();
	var start = start_date!='' || start_date!=null ? moment(start_date).format('hh:mm a') : '17:00 pm';
	rows.each(function(index) {
		if(jQuery(this).hasClass('day-separator')){
			var field_start = jQuery(this).find('.acf-field-59d2674f973fa input').val();
			start = field_start=='' || field_start==null ? '17:00 pm' : field_start;
		}
		else {
